...
//uniform vec4  DifColor = vec4( 0.35, 0.35, 0.5, 1.0 );
uniform vec4  SpecColor = vec4( 0.4, 0.4, 0.2, 1.0 );
uniform vec4  ULColor = vec4( 0.5, 0.3875, 0.75, 1.0 );
uniform vec4  LRColor = vec4( 0.75, 0.5, 0.5, 1.0 );
