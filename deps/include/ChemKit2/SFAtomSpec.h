 ...
 * SFAtomSpec.h
 *
 *	This file defines the SFAtomSpec class.
 *
...
//////////////////////////////////////////////////////////////////////////////
//
//  SFAtomSpec subclass of SoSField.
//
//////////////////////////////////////////////////////////////////////////////

class CHEMKIT_DLL_API SFAtomSpec : public SoSField {
    // Use standard field stuff
    SO_SFIELD_HEADER(SFAtomSpec, SbAtomSpec, const SbAtomSpec &);
  ...
  public:
    ...
    // Set value from the 3 components
  ...
  private:
    ...
    void setVal(ChemBaseData *chemData,
                ChemDisplay *chemDisplay,
                int32_t theAtom);
};

#endif /* !__SF_ATOMSPEC_H__ */
