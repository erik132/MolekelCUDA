 ...
 * MFVec2AtomSpec.h
 *
 *	This file defines the MFVec2AtomSpec class.
 *
...
#ifndef  __MF_VEC2ATOMSPEC_H__
#define  __MF_VEC2ATOMSPEC_H__
...
//////////////////////////////////////////////////////////////////////////////
//
//  MFVec2AtomSpec subclass of SoSField.
//
//////////////////////////////////////////////////////////////////////////////

class CHEMKIT_DLL_API MFVec2AtomSpec : public SoMField {
    // Use standard field stuff
    SO_MFIELD_HEADER(MFVec2AtomSpec, SbVec2AtomSpec, const SbVec2AtomSpec &);
  ...
  public:
    ...
    // Set value from array of 2 SbAtomSpec's
    void        set1Value(int index, const SbAtomSpec ij[2]);
