/*
 * ChemDisplaySelectionElement.h
 *
 *	This file defines the ChemDisplaySelectionElement class.
 *
...
SoEXTENDER class CHEMKIT_DLL_API ChemDisplaySelectionElement : public SoElement {

    SO_ELEMENT_HEADER(ChemDisplaySelectionElement);
  ...
  public:
    ...
    const ChemDisplayPathList &getList() const
        { return selectionList; }

    // Returns the top (current) instance of the element in the state
    static const ChemDisplaySelectionElement * getInstance(SoState *state)
        { return (const ChemDisplaySelectionElement *)
  ...
  SoINTERNAL public:
    ...
    // Initializes the ChemDisplaySelectionElement class
    ...
    // Destructor
    virtual ~ChemDisplaySelectionElement();

  protected:
    ChemDisplayPathList selectionList;
};

#endif /* !__CHEM_DISPLAY_SELECTION_ELEMENT_H__ */
