 ...
 * MFVec4i.h
 *
 *	This file defines the MFVec4i class.
 *
...
//////////////////////////////////////////////////////////////////////////////
//
//  MFVec4i subclass of SoMField.
//
//////////////////////////////////////////////////////////////////////////////

// C-api: prefix=SoMV3i
class CHEMKIT_DLL_API MFVec4i : public SoMField {
    // Use standard field stuff
    SO_MFIELD_HEADER(MFVec4i, SbVec4i, const SbVec4i &);
  ...
  public:
    ...
    // C-api: name=SetIJKLs
    void        setValues(int start, int num, const int32_t ijkl[][4]);

    // Set one value from 4 floats
        // C-api: name=Set1I_J_K_L
    void        set1Value(int index, int32_t i, int32_t j,
                          int32_t k, int32_t l);

    // Set one value from 4 floats in array
        // C-api: name=Set1IJKL
    void        set1Value(int index, const int32_t ijkl[4]);

    // Set to one value from 4 floats
        // C-api: name=SetI_J_K_L
    void        setValue(int32_t i, int32_t j, int32_t k, int32_t l);

    // Set to one value from 4 floats in array
        // C-api: name=SetIJK
    void        setValue(const int32_t ijkl[4]);
