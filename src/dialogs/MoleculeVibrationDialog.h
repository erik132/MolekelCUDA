#ifndef MOLECULEVIBRATIONDIALOG_H_
#define MOLECULEVIBRATIONDIALOG_H_
//
...
/// Container for MoleculeVibrationWidget
class MoleculeVibrationDialog : public QDialog
{
    Q_OBJECT
public:
    /// Constructor.
    ...
    MoleculeVibrationDialog( MolekelMolecule *mol,
                             AtomVibrationAnimator* a,
                             QWidget* parent = 0 ) : QDialog( parent )
    {
        QVBoxLayout* mainLayout = new QVBoxLayout();
        MoleculeVibrationWidget* mvw = new MoleculeVibrationWidget( this );
        mvw->SetMolecule( mol );
        mvw->SetAnimator( a );
...
#endif /*MOLECULEVIBRATIONDIALOG_H_*/
